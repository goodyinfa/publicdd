                                    ...
                                    <tr class="success">
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <a onclick="return confirm('确定要删除吗？');" href="?id=<?php echo $item['pro_id']; ?>" class="btn btn-default btn-gradient dropdown-toggle"><span class="glyphicons glyphicon-trash"></span></a>
                                            </div>
                                        </td>
                                    </tr>
                                <?php } ?>
